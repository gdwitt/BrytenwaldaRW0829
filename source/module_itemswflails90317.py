...
620 , weight(3)|difficulty(1)|spd_rtng(71) | weapon_length(100)|swing_damage(42 , pierce) | thrust_damage(0 , pierce),imodbits_axe ],
 ...
 ["practice_spear","Practice Spear", [("05krokaspjott1",0)], itp_type_polearm|itp_offset_lance| itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 180 , weight(2.25)|difficulty(1)|spd_rtng(94) | weapon_length(145)|swing_damage(15 , blunt) | thrust_damage(27 , pierce),imodbits_polearm],
...
#puesto chief quest
["book_slot","You can read Latin (sell only)", [("book_open",0)], itp_type_book, 0, 500,weight(2)|abundance(60),imodbits_none],#set to musketfor now#only available from abbots
...
# #cambios chief
 ...
 ["jewelry","Jewelry", [("vc_jewelry",0)], itp_merchandise|itp_type_goods, 0, 550,weight(5)|abundance(25)|max_ammo(100),imodbits_none, [], ['fac_kingdom_1','fac_kingdom_7','fac_kingdom_16','fac_kingdom_21','fac_kingdom_26']],
 #vc_jewelry
...
["axe1_alt","Hatchet",[("hatchet",0)],itp_axe1halt,itc_axe1h,360,weight(2)|spd_rtng(87)|weapon_length(60)|swing_damage(16,blunt)|thrust_damage(0,blunt),imodbits_axe], #chief modificado
...
["axe3_alt","Sharp Hatchet",[("axefaradon2",0)],itp_axe1halt,itc_axe1h,490,weight(1.5)|difficulty(6)|spd_rtng(85)|weapon_length(61)|swing_damage(15,blunt)|thrust_damage(0,pierce),imodbits_axe],
...
["axe2_crude_alt","Crude Axe",[("axe_2",0)],itp_axe1halt,itc_axe1h,455,weight(2.1)|difficulty(8)|spd_rtng(71)|weapon_length(72)|swing_damage(16,blunt)|thrust_damage(0,blunt),imodbits_axe],
...
["axe4_alt","Fighting Axe",[("axe_c",0)],itp_axe1halt,itc_axe1h,490,weight(1.5)|difficulty(7)|spd_rtng(83)|weapon_length(70)|swing_damage(15,blunt)|thrust_damage(0,blunt),imodbits_axe],
#differentmesh!!alert
...
["axe2_alt","Cheapaxe",[("gallic_axe_1",0)],itp_axe1halt,itc_axe1h,400,weight(1.5)|difficulty(5)|spd_rtng(75)|weapon_length(71)|swing_damage(14,blunt)|thrust_damage(0,pierce),imodbits_axe,],
...
["axe_englet2_alt","EngleAxe",[("axefaradon3",0)],itp_axe1halt,itc_axe1h,528,weight(2)|difficulty(7)|spd_rtng(81)|weapon_length(74)|swing_damage(16,blunt)|thrust_damage(0,blunt),imodbits_axe,],
...
["axe_longfrankisht3_alt","Frankish Long Axe a",[("vikingaxeb",0)],itp_axe1halt,itc_axe1h,481,weight(2)|difficulty(9)|spd_rtng(79)|weapon_length(80)|swing_damage(24,blunt)|thrust_damage(0 , blunt),imodbits_axe,],
...
["axe_britonbattlet2_alt",   "Frankish Axe", [("frankish_Axe2",0)],itp_axe1halt,itc_axe1h,550 , weight(2)|difficulty(7)|spd_rtng(80) | weapon_length(77)|swing_damage(21 , blunt) | thrust_damage(0 , blunt),imodbits_axe, [], ['fac_kingdom_1','fac_kingdom_2','fac_kingdom_3','fac_kingdom_4','fac_kingdom_5']],
...
["decor_axet3_alt",   "Elite Axea", [("vikingaxe",0)],itp_axe1halt,itc_axe1h,597 , weight(2)|difficulty(8)|spd_rtng(80) | weapon_length(76)|swing_damage(21 , blunt) | thrust_damage(0 , blunt),imodbits_axe, [], ['fac_kingdom_1','fac_kingdom_2','fac_kingdom_3','fac_kingdom_4','fac_kingdom_5', 'fac_kingdom_9','fac_kingdom_13','fac_kingdom_14']],
...
["spear_hvy",   "Heavy Staff Spear", [("fjadraspjot",0)], itp_pike, itc_spear,440,weight(4)|abundance(60)|difficulty(9)|spd_rtng(94)|weapon_length(145)|swing_damage(18,blunt)|thrust_damage(24,pierce),imodbits_polearm ],
["spear_hvy_alt",   "Staff Spear", [("svia2",0)], itp_spear, itc_spear, 521 , weight(2)|abundance(60)|difficulty(8)|spd_rtng(89) | weapon_length(131)|swing_damage(18 , blunt) | thrust_damage(12, blunt),imodbits_polearm ],                                                     
["spear1",   "Spear", [("spjot",0)], itp_spear, itc_spear, 370 , weight(1.4)|abundance(60)|difficulty(7)|spd_rtng(96) | weapon_length(133)|swing_damage(15, blunt) | thrust_damage(25 , pierce),imodbits_polearm ],

["spear2",   "Medium Spear", [("saxon2hspear",0)], itp_spear, itc_spear, 420 , weight(1.4)|abundance(6)|spd_rtng(98) | weapon_length(144)|swing_damage(16, blunt) | thrust_damage(26, pierce),imodbits_polearm ],
["spearlight",   "Light Spear", [("hoggkesja",0)], itp_spear, itc_spear, 265 , weight(1.3)|abundance(67)|difficulty(6)|spd_rtng(107) | weapon_length(125)|swing_damage(11, blunt) | thrust_damage(23 , pierce),imodbits_polearm ],
["spearboar",   "Boar Spear", [("svia2",0)], itp_spear, itc_spear, 521 , weight(2)|abundance(60)|difficulty(8)|spd_rtng(92) | weapon_length(131)|swing_damage(17 , blunt) | thrust_damage(26, pierce),imodbits_polearm ],

#long spear
["spearlong",   "Basic Cav Spear", [("spjotkesja",0)], itp_spear, itc_spear, 480 , weight(2.10)|abundance(50)|difficulty(8)|spd_rtng(97) | weapon_length(185)|swing_damage(12 , blunt) | thrust_damage(30 , pierce),imodbits_polearm ],
["spearwarlong",   "Long War Spear", [("langr_bryntvari",0)], itp_spear, itc_pike, 570, weight(3.08)|abundance(60)|difficulty(10)|spd_rtng(95) | weapon_length(200)|swing_damage(12 , blunt) | thrust_damage(33 , pierce),imodbits_polearm ],
#britones lanzas#gdw use the hasta mesh for another speartier2blades
["spear_hasta",   "Hasta", [("hasta",0)], itp_bladespear, itc_spear, 540, weight(3)|difficulty(10)|spd_rtng(95) | weapon_length(141)|swing_damage(18 , blunt) | thrust_damage(27 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_hasta_alt",   "Hasta", [("hasta",0)], itp_spearalt, itc_spear, 540, weight(3)|difficulty(10)|spd_rtng(95) | weapon_length(145)|swing_damage(19 , blunt) | thrust_damage(5 , blunt),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_blade1t2",   "Blade Spear", [("ped_heavy_spear_long",0)], itp_bladespear, itc_bladespear, 595 , weight(2.5)|difficulty(10)|spd_rtng(97) | weapon_length(132)|swing_damage(26 , cut) | thrust_damage(22 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_blade1t2_alt",   "Blade Spear", [("ped_heavy_spear_long",0)], itp_spearalt, itc_spear, 540, weight(3)|difficulty(10)|spd_rtng(88) | weapon_length(145)|swing_damage(16 , blunt) | thrust_damage(5 , blunt),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_blade2t2",   "Roman long hasta 2", [("roman_spear_2",0)], itp_bladespear, itc_bladespear, 569 , weight(3)|difficulty(10)|spd_rtng(94)|abundance(20) | weapon_length(145)|swing_damage(20 , cut) | thrust_damage(26 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_blade2t2_alt",   "Roman long hasta 2alt", [("roman_spear_2",0)], itp_spearalt, itc_staff, 567 , weight(3)|difficulty(10)|spd_rtng(86)|abundance(20) | weapon_length(145)|swing_damage(19, blunt) | thrust_damage(15 , blunt),imodbits_polearm],
# #spear de dos manos britona
["spear_briton2ht3",   "Briton Two-Handed Blade Spear", [("langr_hoggspjott1",0)], itp_bladespear, itc_bladespear, 690 , weight(3)|abundance(20)|difficulty(11)|spd_rtng(97) | weapon_length(137)|swing_damage(23 , cut) | thrust_damage(26 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_briton2ht3_alt",   "Briton Two-Handed Blade Spear", [("langr_hoggspjott1",0)], itp_spearalt, itc_bladespear, 690 , weight(3)|abundance(20)|difficulty(11)|spd_rtng(88) | weapon_length(137)|swing_damage(24 , blunt) | thrust_damage(9 , blunt),imodbits_polearm],
["spear_britonshortt2",   "Briton Short Spear", [("01atgeirr1",0)], itp_spear, itc_spear, 380 , weight(1.1)|abundance(40)|difficulty(7)|spd_rtng(117) | weapon_length(118)|swing_damage(12 , blunt) | thrust_damage(26 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_britonmedt2",  "Briton Medium Spear", [("02spjot",0)], itp_spear, itc_spear, 430 , weight(1.4)|abundance(40)|difficulty(8)|spd_rtng(100) | weapon_length(142)|swing_damage(15 , blunt) | thrust_damage(28 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_britonlight",   "Briton Light Spear", [("01krokaspjott2",0)], itp_spear, itc_spear, 250 , weight(0.7)|abundance(66)|difficulty(6)|spd_rtng(110) | weapon_length(119)|swing_damage(10 , blunt) | thrust_damage(27 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["spear_briton_longt2", "Briton Cav Spear", [("01langr_bryntvari",0)], itp_spear, itc_spear, 525 , weight(3)|abundance(47)|difficulty(10)|spd_rtng(96) | weapon_length(190)|swing_damage(13 , blunt) | thrust_damage(32 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],
["longspeart3",   "Briton Pike", [("02spjotkesja",0)], itp_spear, itc_spear, 540 , weight(2.55)|abundance(50)|difficulty(8)|spd_rtng(96) | weapon_length(230)|swing_damage(14 , blunt) | thrust_damage(34 , pierce),imodbits_polearm,
[], ['fac_kingdom_6', 'fac_kingdom_7', 'fac_kingdom_8', 'fac_kingdom_10', 'fac_kingdom_11', 'fac_kingdom_12', 'fac_kingdom_15', 'fac_kingdom_16', 'fac_kingdom_18', 'fac_kingdom_21', 'fac_kingdom_22', 'fac_kingdom_23', 'fac_kingdom_24', 'fac_kingdom_25', 'fac_kingdom_26']],

# #saxon 2 h spear, lanza a dos manos
["twohand_speart3",   "Saxon Two-Handed Blade Spear", [("saxon2hspear",0)], itp_bladespear, itc_bladespear, 600 , weight(3)|difficulty(11)|spd_rtng(96) | weapon_length(139)|swing_damage(23 , cut) | thrust_damage(27 , pierce),imodbits_polearm,
[], ['fac_kingdom_1', 'fac_kingdom_2', 'fac_kingdom_3', 'fac_kingdom_4', 'fac_kingdom_5', 'fac_kingdom_9', 'fac_kingdom_13', 'fac_kingdom_14']],
...
["saxon_medium_speart2", "Saxon Spear", [("saxon_spear",0)], itp_spear, itc_spear, 480, weight(2)|difficulty(8)|spd_rtng(96)|weapon_length(140)|swing_damage(15,blunt)|thrust_damage(30,pierce), imodbits_polearm,
[], ['fac_kingdom_1', 'fac_kingdom_2', 'fac_kingdom_3', 'fac_kingdom_4', 'fac_kingdom_5', 'fac_kingdom_9', 'fac_kingdom_13', 'fac_kingdom_14']],
 #1 manoasdfasdf
["germanshortspeart2",   "German Short Spear", [("atgeirr1",0)], itp_pike, itc_spear, 480 , weight(0.69)|abundance(60)|difficulty(7)|spd_rtng(121) | weapon_length(116)|swing_damage(12 , blunt) | thrust_damage(26 , pierce),imodbits_polearm,
[], ['fac_kingdom_1', 'fac_kingdom_2', 'fac_kingdom_3', 'fac_kingdom_4', 'fac_kingdom_5', 'fac_kingdom_9', 'fac_kingdom_13', 'fac_kingdom_14']],
["germanshortspeart2_alt",   "German Staff Spear", [("02spjotkesja",0)], itp_spearalt, itc_staff, 180 , weight(2.55)|abundance(60)|difficulty(8)|spd_rtng(90) | weapon_length(116)|swing_damage(16 , blunt) | thrust_damage(3 , blunt),imodbits_polearm],
["engle_speart2",   "Engle Spear", [("saxon_spear",0)], itp_spear, itc_spear, 510 , weight(2)|difficulty(10)|spd_rtng(94) | weapon_length(149)|swing_damage(15 , blunt) | thrust_damage(33 , pierce),imodbits_polearm,
[], ['fac_kingdom_1', 'fac_kingdom_2', 'fac_kingdom_3', 'fac_kingdom_4', 'fac_kingdom_5', 'fac_kingdom_9', 'fac_kingdom_13', 'fac_kingdom_14']],
["germanlongspeart2",   "Saxon Long Spear", [("langr_svia",0)],itp_pike, itc_spear, 590 , weight(3)|difficulty(10)|spd_rtng(88) | weapon_length(190)|swing_damage(15 , blunt) | thrust_damage(34 , pierce),imodbits_polearm,
[], ['fac_kingdom_1', 'fac_kingdom_2', 'fac_kingdom_3', 'fac_kingdom_4', 'fac_kingdom_5', 'fac_kingdom_9', 'fac_kingdom_13', 'fac_kingdom_14']],
["germanlongspeart2_alt",   "Saxon Long Spear", [("langr_svia",0)],itp_spearalt, itc_staff, 500 , weight(3.25)|difficulty(8)|spd_rtng(85) | weapon_length(190)|swing_damage(18 , blunt) | thrust_damage(16 , blunt),imodbits_polearm],
# Goedendag Irish y pictos
["hunting_spear", "Hunting Spear", [("04hoggkesja",0)], itp_spear, itc_spear, 160 , weight(1.7)|abundance(60)|difficulty(6)|spd_rtng(100) | weapon_length(125)|swing_damage(14 , blunt) | thrust_damage(25 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
["medium_speaript3",   "Elite Gael Med Spear", [("02bryntvari",0)], itp_pike, itc_spear, 580 , weight(2.25)|difficulty(9)|abundance(20)|spd_rtng(99) | weapon_length(140)|swing_damage(16 , blunt) | thrust_damage(34 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
["medium_speaript3_alt",   "Medium Spear", [("02bryntvari",0)], itp_spearalt, itc_staff,580 , weight(2.25)|difficulty(6)|spd_rtng(93) | weapon_length(140)|swing_damage(17 , blunt) | thrust_damage(13 , blunt),imodbits_polearm],
["pictish_boar_speart2",   "Pictish Boar Spear", [("02svia2",0)], itp_spear, itc_spear,425 , weight(3)|abundance(50)|difficulty(8)|spd_rtng(93) | weapon_length(135)|swing_damage(18 , blunt) | thrust_damage(29 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
["warspear_godelict3",   "Godelic Elite Spear", [("03bryntvari",0)], itp_spearunique, itc_spear,580 , weight(2.9)|difficulty(6)|spd_rtng(99) | weapon_length(152)|swing_damage(16 , blunt) | thrust_damage(34 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
["warspear_godelict3_alt",   "Godelic Elite Spear", [("03bryntvari",0)], itp_spearalt, itc_staff, 180 , weight(2.25)|difficulty(6)|spd_rtng(95) | weapon_length(152)|swing_damage(16 , blunt) | thrust_damage(13 , blunt),imodbits_polearm],
["spear_lightgael",   "Godelic Light Spear", [("05hoggkesja",0)], itp_test2hspear, itc_spear,160 , weight(1.7)|abundance(60)|difficulty(6)|spd_rtng(118) | weapon_length(117)|swing_damage(12 , blunt) | thrust_damage(26 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
["spear_lightgael_alt",   "Gael Staff Spear", [("02spjotkesja",0)], itp_spearalt, itc_staff, 180 , weight(2.55)|abundance(60)|difficulty(8)|spd_rtng(116) | weapon_length(117)|swing_damage(17 , blunt) | thrust_damage(9 , blunt),imodbits_polearm],
["long_speaript2",   "Godelic Pike", [("fjadraspjot",0)], itp_spear, itc_spear, 440 , weight(4)|abundance(60)|difficulty(9)|spd_rtng(94) | weapon_length(225)|swing_damage(15 , blunt) | thrust_damage(34 , pierce),imodbits_polearm,
[], ['fac_kingdom_20', 'fac_kingdom_17', 'fac_kingdom_19', 'fac_kingdom_27', 'fac_kingdom_28', 'fac_kingdom_29', 'fac_kingdom_30', 'fac_kingdom_31']],
...
["spear_cavalrylance1",   "Dawn Ray Cav", [("krokaspjott1",0)], itp_pike, itc_spear, 580, weight(2.55)|abundance(20)|spd_rtng(89) | weapon_length(185)|swing_damage(13 , blunt) | thrust_damage(34 , pierce),imodbit_balanced ],
["spear_cavalrylance1_alt",   "Dawn Ray Cav", [("krokaspjott1",0)], itp_spearalt, itc_staff, 260 , weight(2.55)|abundance(20)|spd_rtng(89) | weapon_length(185)|swing_damage(14 , blunt) | thrust_damage(13 , blunt),imodbit_balanced ],
#lanzas magicas especiales reyes y nobles  #short meshes: 02svia2  05bryntvari2  svia2 04hoggkesja-  01krokaspjott2
["spear_elitequest1",   "rHope LongWarrior", [("02krokaspjott1",0)], itp_pike, itc_spear, 360 , weight(2.55)|difficulty(5)|spd_rtng(99) | weapon_length(177)|swing_damage(13 , blunt) | thrust_damage(37 , pierce),imodbit_balanced ],
["spear_elitequest1_alt",   "rHopelong3", [("ped_heavy_spear_long",0)], itp_spearalt, itc_staff, 360 , weight(2.55)|difficulty(8)|spd_rtng(90) | weapon_length(185)|swing_damage(19 , blunt) | thrust_damage(19 , blunt),imodbit_balanced ],
["spear_elitequest2",   "s7britonwarsp", [("01langr_bryntvari",0)], itp_pike, itc_spear, 360 , weight(2.55)|difficulty(6)|spd_rtng(92) | weapon_length(200)|swing_damage(15 , blunt) | thrust_damage(43 , pierce),imodbit_balanced ],
["spear_elitequest2_alt",   "s8reBreath of Dragon", [("05bryntvari2",0)], itp_spearalt, itc_staff, 360 , weight(2.55)|difficulty(6)|spd_rtng(90) | weapon_length(200)|swing_damage(23 , blunt) | thrust_damage(25 , blunt),imodbit_balanced ],
#05bryntvari2 was breathfjadraspjot01langr_bryntvari
["spear_elitequest3",   "s9rRaven", [("fjadraspjot",0)], itp_test2hspear, itc_spear, 360 , weight(2.55)|difficulty(6)|spd_rtng(118) | weapon_length(142)|swing_damage(22 , blunt) | thrust_damage(37 , pierce),imodbit_balanced ],
["spear_elitequest3_alt",   "s10roman", [("roman_spear_2",0)], itp_spearalt, itc_staff, 360 , weight(2.55)|difficulty(6)|spd_rtng(118) | weapon_length(144)|swing_damage(30 , blunt) | thrust_damage(5 , blunt),imodbit_balanced ],
#lanzas especiales chief
["spear_elitequest4","Neko's Spear", [("krokaspjott1",0)] , itp_spearunique, itc_spear, 1060,weight(2.55)|difficulty(6)|spd_rtng(94) | weapon_length(185)|swing_damage(13 , blunt) | thrust_damage(36 , pierce),imodbit_balanced ], #chief cambiado
["spear_elitequest4_alt","Neko's Spear", [("krokaspjott1",0)] , itp_spearalt, itc_staff, 1060,weight(2.55)|difficulty(6)|spd_rtng(94) | weapon_length(180)|swing_damage(13 , blunt) | thrust_damage(29 , blunt),imodbit_balanced ], #chief cambiado
...
["spearbannert2",   "Fighting Banner", [("wessexbanner3",0)], itp_banner, itc_spear, 690 , weight(2)|difficulty(8)|spd_rtng(86) | weapon_length(139)|swing_damage(18 , blunt) | thrust_damage(24 , pierce),imodbits_polearm ], #chief cambiado
...
["spearbanner4",   "Banner", [("wessexbanner4",0)],itp_staff, itc_spear, 640 , weight(5)|difficulty(8)|spd_rtng(80) | weapon_length(148)|swing_damage(18 , blunt) | thrust_damage(25 , pierce),imodbits_polearm ], #chief cambiado
["spearbanner5",   "Banner", [("wessexbanner5",0)], itp_staff, itc_spear, 648 , weight(5)|difficulty(8)|spd_rtng(75) | weapon_length(149)|swing_damage(18 , blunt) | thrust_damage(26 , pierce),imodbits_polearm ], #chief cambiado
...
["heraldicbannert3",   "Heraldic Banner", [("personalbanner",0)],itp_banner, itc_spear, 860 , weight(5)|difficulty(8)|spd_rtng(89) | weapon_length(135)|swing_damage(22 , blunt) | thrust_damage(27 , pierce),imodbits_polearm, 
