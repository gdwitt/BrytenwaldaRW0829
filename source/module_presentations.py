...
from header_mission_templates import* ##this fixes mordr error
      ...
      # [
        ...
        # (try_begin),
          ...
          # (else_try),
           ...
           # (fadction_get_slot, ":old_marshall", "$players_kingdom", "slot_faction_marshall"),
           # (try_begin),
             # (ge, ":old_marshall", 0),
        ...
        # ]),
     # ]),
("battle",0,0,[  ##gdw 40916 this is double script due to the battle.orders missing components
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
...
+ loans.presentations \
#+ battle.presentations \ ###temporary40916 testing gdwitt
