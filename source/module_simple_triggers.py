   ...
   [
    ...
    (try_end),
      ...
      (try_begin), #Disaster
        ...
        (val_max, ":num_cattle", 10),##delete this after test082816
...
#TAXES begin chief SoD
		(try_begin),
			...
			(assign, ":multiplier", 0),
			(party_get_slot, ":faith", ":center_no", "slot_center_sod_local_faith"),
			(val_mul, ":faith", -1),##What is the purpose of this? gdw
			(val_div, ":faith", 10),
			(val_add, ":multiplier", ":faith"),
			(try_end),
		(try_end),
...
##gdw this was in enterprise folder but see compiler error returned here
...
(24 * 7,
	...
	(try_end),
		...
		(val_add, "$g_sod_global_faith", 3),
			...
			(party_set_slot, ":center_no", "slot_center_player_relation", ":cur_relation"),
		# DEBUG REMOVE ME
(display_message, "@New shrine place is working"),#addedbackin due to report bug gdw
	(try_end),
	]),
...
(24 * 7,
    ...
    (try_begin),
      ...
      (eq, "$g_sod_faith", 4),                                                       
			(val_div, ":cur_faith", 14),##gdw was 20
    (else_try),
      (this_or_next|eq, "$g_sod_faith", 2),
			(eq, "$g_sod_faith", 3),
			(val_mul, ":cur_faith", -1),
...
##gdw removed because it seemed to cause lag
  #Sladki
