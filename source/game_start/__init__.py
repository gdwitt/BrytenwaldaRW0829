    ...
    ("start_game_0", menu_text_color(0xFF000000) | mnf_disable_all_keys,
     ...
     [], [
         ...
         ("start_mod", [], "Quick Character (mod testing - go to CHARACTER screen first)", [
              ...
              (troop_add_item, "trp_player", "itm_noblearmor3res", 1),
              ...
              (troop_add_item, "trp_player", "itm_noblemanshirt3", 0),
        ...
        (troop_add_item, "trp_player","itm_decor_axet3",0),
        (troop_add_item, "trp_player","itm_spathaswordt2",0),
        ...
        #(party_add_members, "p_main_party", "trp_npcpictlady", 1),
