...
##diplomacy end+
  ...
  (
    ...
    [
      ...
      ("appoint_npcneko",[
	  (main_party_has_troop, "trp_npcneko"),
	  (str_store_troop_name, s10, "trp_npcneko"),
	  ],"Appoint {s10}",
       [
	   (assign, "$g_player_minister", "trp_npcneko"),
	   (jump_to_menu, "mnu_minister_confirm"), ]),
	   
      ("appoint_npc18",[
	  (main_party_has_troop, "trp_cado"),
	  (str_store_troop_name, s10, "trp_cado"),
	  ],"Appoint {s10}",
       [
	   (assign, "$g_player_minister", "trp_cado"),
	   (jump_to_menu, "mnu_minister_confirm"), ]),
