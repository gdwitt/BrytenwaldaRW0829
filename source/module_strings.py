...
#duplicates i know but we are having string problems with gender  31316gdw
  ("father", "father"),
  ("husband", "husband"),
  ("wife", "wife"),
  ("daughter", "daughter"),
  ...
  ("he", "He"),
  ("she", "She"),
#duplicates i know but we are having string problems with gender  
  ("s3s_s2", "{s3}'s {s2}"),
  ("s5_is_s51", "{s5} is {s51}."),
...
#chief dialogo companeros cambiado entero por Wilsonrtf  
  ...
  ("npc_pict2_intro", "Hi , traveler (The stranger greets you and asks to share a few words... and drinks.)"),
  ("npc_pict1_intro", "Hi (The stranger greets you and asks to share a few words... and drinks.)"),#ciniod
  ...
  ("npc_pict2_intro_response_1", "Very well, I'll follow you, and we shall share some tales."),
  ...
  ("npc_pict2_intro_response_2", "Not right now, Pict."),
...
# NPC 2/ b "mind your own business"
  ...
  ("npc_pict2_backstory_a", "(You follow the stranger to an open table in a quiet corner of the room. You exchange a brief introduction, and the stranger begins to tell about his life.)"),
 ...
 #backstory main body
  ...
  ("npc_pict2_backstory_b", "(The stranger speaks of his long gone past - of sorrow and glory, of courage and fear; time passes fast while you drink your beer and hear him. He is a Pict and he looks intelligent and brave... This person could be useful to you in your travels, both in peace and in war...)"),
...
#backstory recruit pitch
  ...
  ("npc_pict2_backstory_c", "(The Pict concludes his story and leans backwards, taking a long draught and simply rests while you ponder about the tale of his life...)"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc_pict2_backstory_later", "Your friend recalls their recent activities, but seems more interested in rejoining your company than swapping news."),
  ...
  ("npc_pict2_backstory_response_1", "Invite the Pict to join your shield-wall."),
...
# NPC 4/a "its 300 to join"
 ...
 ("npc19_backstory_response_1", "Ah yes, I will be needing a engineer."),
  ...
  ("npc_pict2_backstory_response_2", "Take your leave."),
...
# NPC 4/b "No sorry friend"
 ...
 ("npc19_backstory_response_2", "Sorry friend I don't need anyone like you for now."),
  ...
  ("npc_pict2_signup", "Thank you. My fate seemed uncertain, but you have given me a goal. I will be your bodyguard. An elite warrior fighting only by your side."),
...
# NPC 5/a   "I'll get my gear"
  ...
  ("npc_pict2_signup_2", "You have just gladdened my day, you could not have found a more faithful bodyguard."),
...
# NPC 5/b   "I wont let you down"
  ...
  ("npc_pict2_signup_response_1", "Hire the Pict."),
...
#11
  ...
  ("npc_pict2_signup_response_2", "Retract your offer and leave."),
...
# NPC 6/b "Cont bother"
  ...
  ("npc_pict2_payment", "Before I sign up, I will require 300 coins in payment."),
  ...
  ("npc_pict2_payment_response", "All right, here's {reg3} scillingas. Glad to have you with us."), 
  ...
  ("npc_pict2_morality_speech", "I do not care to {s21}. No one with a reputation for blatant cowardice will be properly respected and obeyed by his shield-wall."),
  ...
  ("npc_pict2_2ary_morality_speech", "You know, friend {playername}, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me, that's how I figure it."),
...
####Pausa - conflitos chief
  ...
  ("npc_pict2_personalityclash_speech", "Warlord, I am weary of {s11}, who talks of nothing but warrior codes and feats of arms."),
  ...
  ("npc_pict2_personalityclash_speech_b", "Valorous deeds are all very well, but they are not the only goals worth pursuing in life. Personally, I never trust any man who has not at least once woken up drunk in a ditch, or been beaten by the slipper of his lover before."), 
...
### set off by behavior after victorious battle
  ...
  ("npc_pict2_personalityclash2_speech", "Hello, warlord! {s11} is a temperamental one, isn't he? During that last battle, I was merely having a friendly chat with our foes about their mothers as we exchanged sword blows, and it caused him to throw a fit!."),
  ...
  ("npc_pict2_personalityclash2_speech_b", "When all the dust settled, {s11} turned on me and told me not to 'tempt the wrath of the Heavens' with my 'hubris.' I responded that he should care about the men he coldly killed after the battle is over, which I think angers the Gods a lot more than battlefield small talk. Then {s11} turned red like a virgin's face and would have struck me had I not artfully dodged out of his away. Tell him to lighten up, will you?"),
  ...
  ("npc18_personalityclash2_speech_b", "{s11} must go. No one will take my drills seriously until he's gone. He's mocks me behind my back."),
  ...
  ("npc_pict2_personalitymatch_speech", "You have earned your name today, {sir/madame}! And {s11}, too! I like that one, a strong companion in the battlefield."),
  ...
  ("npc_pict2_personalitymatch_speech_b", "He is a professional soldier, and a great killer of men. You showed good sense in bringing him into this shield-wall."),
  ...
  ("npc_pict2_retirement_speech", "{Sir/Madame} I have decided to leave this joke you call a shield-wall. I can no longer stand your filthy company. Farewell."),
  ...
  ("npc_pict2_rehire_speech", "Well hello there {sir/madame}. Well, I was wrong. You are not that filthy, nor completely intolerable. Perhaps we might ride together again, for a little while?"),
...
#local color strings
  ...
  ("npc_pict2_home_intro", "Do you see that Pictish town? I spent many winters there some years back, during my childhood."), 
  ...
  ("npc_pict2_home_description", "It is the most pleasant countryside in this whole island, and a great place for a retired warrior to settle down."),
  ...
  ("npc_pict2_home_description_2", "If anyone were ever to unify these islands of ours, I'd eventually return to my birthplace, get a small house and a nice woman to raise some kids of my own. But, alas, I am only dreaming, of course."),
  ...
  ("npc_pict2_home_recap", "I was born in Pictland. I'm just a man in this world of war."),
  ...
  ("npc_pict2_kingsupport_1", "Why not, warlord? I mean, in this war-torn and rainy island, you would be as good a King as any of those self-proclaimed conquerors that roam the fields stealing cattle and burning villages."), 
  ...
  ("npc_pict2_kingsupport_2", "Of course, my {lord/lady}. I very well remember how you rescued me in that dark tavern, and gave me a new life. I shall travel the land, telling people how you can bring hope to even the most desperate man."), 
  ...
  ("npc_pict2_kingsupport_2a", "Interesting... Please continue"), 
  ...
  ("npc_pict2_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take. I am no hope-bringer."), 
  ...
  ("npc_pict2_kingsupport_3", "Give me leave for a few weeks. If people start to see you as a glimmer of hope in these dark times, even a faint one, it will surely be easier for them to accept you as a rightful ruler. What do you say to that, warlord?"), 
  ...
  ("npc_pict2_kingsupport_objection", "Warlord -- I cannot agree with the arguments you allowed to be said in your name for the sake of your future as King. They are wrong, terribly wrong. And you know it. I am sorry to speak my mind in this rude tone, but I could no longer keep my mouth shut in face of such iniquity."), 
  ...
  ("npc_pict2_fief_acceptance", "Well, {sir/my lady}, that's a gracious act, and marks you as the kind of monarch who can save this sorry land from the incompetence of the current batch. I suspect a lot of the noble lords around here will think that a commoner like me isn't fit to hold a fief. Well, when they see what I do with it, and what revenues I can bring in, they'll change their tune!"), 
...
("the_coast", "the coast"),
  ...
  ("enterprise_s5_at_s0", "Net revenue from {s5} at {s0}"), ##gdw 40916
  ("bread_site", "mill"),
  ("ale_site", "brewery"),
  ("oil_site", "oil press"),
...
#trading and training see caravan submod
("member_finished_studying", "{s2} has finished the training."),
("member", "10 {s2} joined your party."),
