   ...
   # (gt, ":item_no", 0),
    ...
    #(else_try),
      ...
      (try_for_range, ":item_slot", ek_item_0, ":end"),
        ...
        (try_begin),
          (assign, reg1, ":item_id"),
          (item_get_swing_damage_type, ":damage_type_swing", reg1),
          (assign, reg0, ":damage_type_swing"),
          (try_begin),
            (eq, ":damage_type_swing", pierce),
            (val_div, ":swdamage", 3),
            (val_mul, ":swdamage", 2),
            (val_add, ":swdamage", 256),
            (item_set_slot, reg3, "slot_item_swing_damage", ":swdamage"),
          (else_try),
            (eq, ":damage_type_swing", cut),
            (val_div, ":swdamage", 3),
            (val_mul, ":swdamage", 2),
            (val_add, ":swdamage", 512),
            (assign, reg2, ":swdamage"),
            (item_set_slot, reg3, "slot_item_swing_damage", ":swdamage"),
            (display_message, "@[DEBUG] agent {reg10} w item {reg1} with sdamagetype {reg0} has {reg2} as new swingcut damage"),
          (else_try),
            (display_message, "@[DEBUG] swing for {reg3} maybe blunt"),
          (try_end),

          (item_get_thrust_damage_type, ":damage_type_thrust", reg3),
          (assign, reg0, ":damage_type_thrust"),
          (try_begin),
            (eq, ":damage_type_thrust", pierce),
            (val_div, ":thdamage", 3),
            (val_add, ":thdamage", 256),
            (assign, reg2, ":thdamage"),
            (item_set_slot, reg2, "slot_item_thrust_damage", ":thdamage"),
            (display_message, "@[DEBUG] agent {reg10} w item {reg1} with tdamagetype {reg0} has {reg2} as new thpierce damage"),
          (else_try),
            (eq, ":damage_type_thrust", cut),
            (val_div, ":thdamage", 3),
            (val_add, ":thdamage", 512),
            (item_set_slot, reg3, "slot_item_thrust_damage", ":thdamage"),
          (else_try),
            (display_message, "@[DEBUG] thrust for {reg3} maybe blunt"),
          (try_end),
